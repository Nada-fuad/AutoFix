...
public static class VehicleErrors
{
    ...
    public static Error LicensePlateRequired => Error.Validation("Vehicle_LicensePlate_Make_Required", "Vehicle license plate is required");

    public static Error YearInvalid => Error.Validation("Vehicle_Year_Invalid", "Year must be between 1886 and next year.");
