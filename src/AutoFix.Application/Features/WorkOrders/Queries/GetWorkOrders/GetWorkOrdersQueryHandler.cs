...
namespace AutoFix.Application.Features.WorkOrders.Queries.GetWorkOrders
{
    public class GetWorkOrdersQueryHandler(IAppDbContext context) : IRequestHandler<GetWorkOrdersQuery, Result<PaginatedList<WorkOrderListItemDto>>>
    {
